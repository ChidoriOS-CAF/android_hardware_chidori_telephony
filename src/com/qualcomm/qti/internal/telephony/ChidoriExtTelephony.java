...
public class ChidoriExtTelephony extends IExtTelephony.Stub {
    ...
    private static ChidoriExtTelephony sInstance;
    ...
    public static ChidoriExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new ChidoriExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private ChidoriExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
